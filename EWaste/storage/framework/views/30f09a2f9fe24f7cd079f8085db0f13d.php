    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav d-flex flex-row me-1">
            <li class="nav-item me-3 me-lg-0">
                <a class="nav-link text-dark" href="#"><i class="fas fa-envelope mx-1"></i> About Us</a>
            </li>
            <li class="nav-item me-3 me-lg-0">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li>
                        <a class="dropdown-item text-dark" href="#">My account</a>
                    </li>
                    <li>
...
<!-- Navbar -->
<?php /**PATH C:\Users\Steven\Desktop\Web-Project\E-Waste\resources\views/component/navBar.blade.php ENDPATH**/ ?>